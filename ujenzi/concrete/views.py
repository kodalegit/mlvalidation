...
class PredictForm(forms.Form):
    ...
    age = forms.IntegerField(min_value=0, max_value=365,
                             initial=0, label='Curing Period')
    water = forms.FloatField(min_value=0, initial=0, label='Water')
    coarseaggr = forms.FloatField(
        min_value=0, initial=0, label='Coarse Aggregate')
    ...
    superplasticizer = forms.FloatField(
        min_value=0, initial=0, label='Superplasticizer')
